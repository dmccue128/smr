...
public interface Component {
	...
	public enum Status {
		...
		ACTIVE,
		/**
		 * IMPAIRED status indicates the component has some limitation of functionality
		 * but is operable at some level.
		 */
		IMPAIRED,
		/**
		 ...
		 * "switched-off" vs. a component that has failed. It only indicates that the
		 * component is not presently operating.
		 */
		INACTIVE
	}
	 ...
	 * @throws ComponentException if an error occurs accessing the device.
	 */
	 ...
	 * no-op.
	 *
	 * @param sim true if connecting to a simulation of the component
	 * @return true if successful
	 * @throws ComponentException if an error occurs accessing the device.
	 */
