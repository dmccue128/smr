...
public class Longitude {
   ...
   */
  private static Pattern DMS_LONGITUDE_PATTERN = Pattern
      .compile("([0-9]+)\u00B0 *([0-9]+)' *([0-9]+)\" *([EeWw])");
   ...
   *
   * @param lon
   *          the longitude in DDM format, e.g., -84 13.888333
   ...
   *
   * @param lon
   *          the longitude in DMS format, e.g., 84�13'53.3"W
   * @return the longitude
   * @throws NumberFormatException
  ...
  /**
   * Get longitude in double, Minutes, Seconds (DMS) format. Example:
   * 84�13'53.3"W
   *
   * @return the longitude
   */
  public final String getDms() {
    ...
    return String.format("%g%s%g'%4.1g\"%c", Double.valueOf(degrees), DEGREE_SYMBOL,
