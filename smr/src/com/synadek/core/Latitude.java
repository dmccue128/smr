...
public class Latitude {
	 ...
	 */
	private static Pattern DMS_LATITUDE_PATTERN = Pattern.compile("([0-9]+)\u00B0 *([0-9]+)' *([0-9]+)\" *([NnSs])");
	 ...
	 * 
	 * @param lat the latitude in DDM format, e.g., 36 59.35333
	 * @return the latitude
	 ...
	 * 
	 * @param lat the latitude in DMS format, e.g., 36x59'21.2"N
	 * @return the latitude
	...
	/**
	 * Get latitude in double, Minutes, Seconds (DMS) format. Example: 36�59'21.2"N
	 * 
	...
	public final String getDMS() {
		...
		return String.format("%g%s%g'%g\"%c", Double.valueOf(Math.floor(degrees)), DEGREE_SYMBOL, Double.valueOf(minutes),
