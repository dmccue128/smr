...
public class JsonSchema {
   ...
   * @param min
   *          minimum value allowed for this field value
   * @param exclusiveMin
   *          is minimum exclusive
   * @return the schema object
   */
  @SuppressWarnings("unchecked")
  public static JSONObject schemaNumber(final String desc, final double min,
      final boolean exclusiveMin) {
    final JSONObject result = new JSONObject();
    result.put(JSON_KEY_DESCRIPTION,
        "Maximum depth of anchor i.e., length of anchor chain in meters.");
   ...
   * @param props
   *          Object containing descriptions of each schema item
   * @param reqd
   *          Array identifying which schema items are required i.e. not
   *          optional
   */
  @SuppressWarnings("unchecked")
  public JsonSchema(final String nam, final String desc, final JSONObject props,
      final JSONArray reqd) {
