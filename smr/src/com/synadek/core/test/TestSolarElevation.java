...
/**
 * Test calculation of solar elevation.
 */
public class TestSolarElevation {
  ...
  public void testHappyPath() throws InvalidValueException {
    double elevation = Solar.getSolarElevation(TestSolar.testLatitude,
        TestSolar.testLongitude, TestSolar.testDateTime);
    double expectedValue = 24.729693032630095;
  ...
  public void testNegativeLatitude() throws InvalidValueException {
    double elevation =
        Solar.getSolarElevation(-360, TestSolar.testLongitude, TestSolar.testDateTime);
  ...
  public void testNegativeLongitude() throws InvalidValueException {
    double elevation =
        Solar.getSolarElevation(TestSolar.testLatitude, -360, TestSolar.testDateTime);
    System.out.println("Did not expect a value for elevation, but got: " + elevation);
  }
  ...
  public void testNullInput() throws InvalidValueException {
    double elevation =
        Solar.getSolarElevation(TestSolar.testLatitude, TestSolar.testLongitude, null);
    System.out.println("Did not expect a value for elevation, but got: " + elevation);
  }
}
