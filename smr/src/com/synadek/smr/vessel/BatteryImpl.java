...
public class BatteryImpl extends VesselComponentImpl implements Battery {
   ...
   */
  private static final float DEFAULT_VOLTAGE = 12.0f;

  /**
   * Maximum allowable simulated voltage.
   */
  private static final float MAX_VOLTAGE = 25.0f;
   ...
   *
   * @param newVoltage
   *          is the new simulated battery voltage in volts.
   * @throws InvalidValueException
   *           if voltage is negative or exceeds MAX_VOLTAGE
   */
