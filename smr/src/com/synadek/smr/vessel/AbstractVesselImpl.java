...
public abstract class AbstractVesselImpl extends AbstractComponent implements Vessel {
   ...
   */
  @Override
  public abstract boolean connect(final boolean sim) throws ComponentException;
  ...
  /**
   * getBooking returns the name of the mission for which this vessel is booked
   ...
   *           if the vessel is already booked on the specified date
   */
