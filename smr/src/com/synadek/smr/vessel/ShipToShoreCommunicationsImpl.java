 ...
 */
public class ShipToShoreCommunicationsImpl extends VesselComponentImpl implements ShipToShoreCommunications {
	 ...
	 * 
	 * @see
	 * com.synadek.smr.vessel.ShipToShoreCommunications#removeListener(com.synadek.
	 * smr.vessel.CommunicationsListener)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.synadek.smr.vessel.ShipToShoreCommunications#sendMessage(java.lang.
	...
	public void sendMessage(String dest, JSONObject metadata, String imagePath) {
		if (this.simulated) {
			log.info("Simulated image message sent to shore: {}, path: {}", metadata.toJSONString(), imagePath);
		} else {
	 ...
	 *
	 * @param source  simulated source of the message
	 * @param message simulated message
	 */
