...
public final class smrControl implements Runnable, ServletContextListener {
	...
	/**
	 * initialization timeout indicates the maximum amount of time (milliseconds) to
	 * wait to initialize.
	 */
	 ...
	 * 
	 * @param arg0 - the ServletContextEvent containing the ServletContext that is
	 *             being destroyed
	 */
	@Override
	...
	/**
	 * contextInitialized is invoked when the web application container is deployed.
	 * Receives notification that the web application initialization process is
	 * starting. Notified of context initialization before any filters or servlets
	 * in the web application are initialized.
	 * 
	 * @param arg0 - the ServletContextEvent containing the ServletContext that is
	 *             being initialized
	 */
	...
	public void contextInitialized(final ServletContextEvent arg0) {
		...
		try {
			...
			// Log the message
			log.info(String.format("Application initialized in %1$,.1f seconds", Double.valueOf(durationSecs)));
	 ...
	 * ShutdownFlag in the configuration database. On application start-up, the flag
	 * can be tested to determine whether the previous shutdown was orderly or
	 * abrupt.
	 */
	...
	/**
	 * Initialization method invoked at application start by the application server.
	 */
