...
public final class Beaufort {
   ...
   */
  private static final double[] beaufortLimits = {0.2, 1.5, 3.3, 5.4, 7.9, 10.7, 13.8, 17.1, 20.7,
      24.4, 28.4, 32.6 };

  /**
   * Standard names for each level of the Beaufort scale.
   */
  private static final String[] beaufortLabels = {"label.calm", "label.lightair",
      "label.lightbreeze", "label.gentlebreeze", "label.moderatebreeze", "label.freshbreeze",
      "label.strongbreeze", "label.neargale", "label.gale", "label.severegale", "label.storm",
      "label.violentstorm", "label.hurricane", };
  ...
  private static final String[] beaufortDescriptions = {"msg.water.calm", "msg.water.lightair",
      "msg.water.lightbreeze", "msg.water.gentlebreeze", "msg.water.moderatebreeze",
      "msg.water.freshbreeze", "msg.water.strongbreeze", "msg.water.neargale", "msg.water.gale",
      "msg.water.severegale", "msg.water.storm", "msg.water.violentstorm",
      "msg.water.hurricane", };

  /*
   * Note: Beaufort levels 6-7 warrant one pennant flag. Levels 8-9, two
   * pennants. Levels 10-11, one storm flag. Level 12 two storm flags.
   */
  /**
  ...
  /**
   * Return speed in Beaufort scale (0-12). Note: negative speeds are invalid
   ...
   *          is the Beaufort number
   * @param locale
   *          is the locale in which to translate the message
