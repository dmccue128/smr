...
/**
 * First Mate -- Responsible for the safety and security of the ship, as well as the welfare of the
 * crew on board.
 */
public class FirstMate extends AbstractCrewMemberFactory {

  /**
   * Default constructor.
   * 
   * @param name
   *          the name of this First Mate
   */
  public FirstMate(final String name) {
    super(name, ROLE_FIRST_MATE);
  }
