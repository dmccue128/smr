...
/**
 * Researcher -- gathers data, operates specialty equipment and reports on
 * research associated with a mission.
 */
public class Researcher extends AbstractCrewMemberFactory {

  /**
   * Default constructor.
   *
   * @param name
   *          the name of this researcher
   */
  public Researcher(final String name) {
    super(name, ROLE_RESEARCHER);
  }
